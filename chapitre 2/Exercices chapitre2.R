...
#Exercice 14
####################################################################################################################
vitesse  = read.csv('Données de vitesse initiale ada.csv', sep=';')
...
mandrel = read.csv("mandrel experience.csv", sep=";")
...
#exercice 13
####################################################################################################################
strenght = read.csv("strenght data.csv", sep=";")
...
#exercice 15
####################################################################################################################
sprayer = read.csv2("Airsprayer.csv", sep=",")
...
machines = read.csv("packing machines.csv", sep=";")
...
#exercice 17
####################################################################################################################
blood = read.csv("Blood Pressure Data.csv", header=T, sep=";")
str(blood)
